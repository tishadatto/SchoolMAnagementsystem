...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="background-image: url(' '); width: 100%; height: 720px; background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
        <div class="container p-md-4 p-sm-4">
            ...
            <h3 class="text-center text-dark">Student's Attendance</h3>
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
              ...
              <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                <div class="col-md-3 col-md-offset-2 mb-3">
                    ...
                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary btn-block" BackColor="#333300" Text="Submit" OnClick="btnSubmit_Click"/>
                ...
                <div class="row mb-3 mr-lg-3 ml-lg-5">
                   <div class="col-md-12">
                    <asp:GridView ID="gvStdAttendance" runat="server" CssClass= "table table-hover table-bordered"
                ...
                <div class="row mb-3 mr-lg-3 ml-lg-5" >
                  <div class="col-md-6 col-lg-4 col-xl-3 col-md-offset-2 mb-4">
                     <asp:Button ID="btnMarkAttendance" runat="server"
                         CssClass="btn btn-primary btn-block" BackColor="#333300" ForeColor="#ffffff" Text="Mark Attendance" OnClick="btnMarkAttendance_Click" />
                </div>
             </div>
